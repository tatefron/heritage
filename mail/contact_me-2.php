<?php
$recipient_email    = "m.anna.bliznuk@gmail.com"; //recepient
$from_email         = "info@ukrainianheritage.online"; //from email using site domain.
...
if($_POST){
   ...
   // $sender_name 	= filter_var($_POST["name"], FILTER_SANITIZE_STRING); //capture sender name
    $sender_email2 	= filter_var($_POST["email"], FILTER_SANITIZE_STRING); //capture sender email
    ...
    //$interest.='Interests:'.$_POST['interest1'].','.$_POST['interest2'].','.$_POST['interest3'].','.$_POST['interest4'].','.$_POST['interest5'].','.$_POST['interest6'].','.$_POST['interest7'].','.$_POST['interest8'].','.$_POST['interest9'].'';
   ...
   //     print json_encode(array('type'=>'error', 'text' => 'Name is too short or empty!'));
    //    exit;
   // }
    if(!filter_var($sender_email2, FILTER_VALIDATE_EMAIL)){ //email validation
    ...
    //    print json_encode(array('type'=>'error', 'text' => 'Company name is too short or empty!'));
    //    exit;
    //}
   ...
   // }
	...
	$message_body .=  "$sender_email2\n";
	// $message_body .=  "$country_code$phone_number\n";
    $message_body .=  "$interest\n";
	
    if($file_count > 0){ //if attachment exists
        //header
        $headers = "MIME-Version: 1.0\r\n"; 
        $headers .= "From:".$from_email."\r\n"; 
        $headers .= "Reply-To: ".$sender_email2."" . "\r\n";
       ...
       $headers = "From:".$from_email."\r\n".
        "Reply-To: ".$sender_email2. "\n" .
        "X-Mailer: PHP/" . phpversion();
        $body = $message_body;
    }
        
    $sentMail = mail($recipient_email,  $body, $headers);//$subject,
